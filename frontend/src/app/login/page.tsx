      ...
      <div className="w-full max-w-[900px] bg-white rounded-3xl overflow-hidden shadow-2xl shadow-black/8 flex"
        ...
        <div className="w-[340px] flex-shrink-0 bg-[#F5F4F0] p-8 flex flex-col">
          ...
          <h2 className="text-3xl font-extrabold text-[#1A1A2E] leading-tight mb-3">
            Welcome back.<br />Your plan is waiting.
          </h2>
          ...
          <div className="mt-8 pt-6 border-t border-[#E8E7F5]">
            ...
            <p className="text-[11px] font-bold text-[#9B9AB5]">— Biology student, Fall 2026</p>
          </div>
        </div>

        {/* ── Right panel ─────────────────────────────────────── */}
        <div className="flex-1 p-8 flex flex-col justify-center">
          <h2 className="text-2xl font-extrabold text-[#1A1A2E] mb-1">Log in to Atlas</h2>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[11px] font-medium text-[#C5C3E8]">or continue with email</span>
            <div className="flex-1 h-px bg-[#F0EFF8]" />
          </div>
          ...
          {error && !hasPassError && (
            <div className="flex items-start gap-2 bg-red-50 border border-red-200 rounded-xl px-3.5 py-3 mb-4">
              ...
              <p className="text-[13px] font-medium text-red-600 whitespace-pre-line">{error}</p>
            </div>
          )}
              ...
              {hasPassError && (
                <div className="flex items-center gap-1.5 mt-1.5">
                  ...
                  <p className="text-[12px] text-red-500 font-medium">
                    Incorrect password.{" "}
                    <a href="#" className="text-[#534AB7] font-semibold hover:underline">Reset it</a>
                  </p>
                </div>
              )}
            </div>
