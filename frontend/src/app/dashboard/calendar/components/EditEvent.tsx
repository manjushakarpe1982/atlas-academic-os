  ...
  return (
    <div className="px-4 py-4 pb-24">
      ...
      <div className="space-y-4">
        ...
        <button onClick={onSaved} className="w-full bg-indigo-600 text-white font-bold py-3.5 rounded-xl hover:bg-indigo-700 transition-all text-sm">
          Save Changes
        </button>
        <button onClick={onBack} className="w-full text-red-600 font-bold py-3 text-sm flex items-center justify-center gap-2">
