...
export default function Step5Page() {
  ...
  return (
    <OnboardingLayout step={5}>
      {/* Same white card wrapper */}
      <div className="bg-white rounded-[28px] border border-[#ECE9FF] shadow-lg overflow-hidden">
        <div className="grid lg:grid-cols-[1fr_360px]">

          {/* LEFT — completion content */}
          <div className="px-8 lg:px-10 py-10 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <h1 className="text-3xl lg:text-4xl font-extrabold text-[#14142B] mb-2">
              You&apos;re all set, {name}! 🎉
            </h1>
            <p className="text-sm text-[#6B6A8A] font-light leading-relaxed mb-7 max-w-sm">
              Your personalised Atlas workspace is ready. Your AI study companion has mapped your goals
              and built your first study plan.
            </p>

            {/* Stats */}
            <div className="grid grid-cols-2 gap-3 mb-7 w-full max-w-xs">
              {[
            ...
            {/* Plan preview */}
            <div className="bg-[#F8F7FF] border border-[#E8E5FD] rounded-2xl p-4 w-full max-w-xs mb-7 text-left">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#534AB7] to-[#6B5FE8] hover:from-[#3C3489] hover:to-[#534AB7] text-white font-extrabold px-8 py-3.5 rounded-2xl text-sm flex items-center gap-2.5 shadow-xl shadow-[#534AB7]/25 transition-all active:scale-95"
            >
