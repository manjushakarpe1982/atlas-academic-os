...
const QUESTIONS: Question[] = [
  {
    ...
    correct: 1,
    explanation:
      'The nuclear envelope begins to break down in prophase but fully disintegrates during prometaphase. This is a common exam mistake — you answered "prophase" on Quiz 3.',
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "PPMAT: Prophase, Prometaphase, Metaphase, Anaphase, Telophase. This mnemonic was on the review sheet.",
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "Kinetochores are protein complexes that assemble on centromeric DNA and serve as attachment points for spindle microtubules that pull chromosomes apart.",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Mitosis produces exactly 2 daughter cells that are genetically identical to the parent (diploid). Meiosis produces 4 haploid cells — a common confusion point.",
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "Anaphase is when kinetochore microtubules shorten, pulling sister chromatids apart toward opposite poles. Dr. Smith emphasised this phase 3× in Lecture 11.",
...
function ResultsScreen({
  ...
  const wrong = QUESTIONS.filter(
    (_, i) => answers[i] !== null && answers[i] !== QUESTIONS[i].correct,
  );
  ...
  const msg =
    pct >= 80
      ? "🌟 Excellent work! Strong understanding of mitosis."
      : pct >= 60
    ...
    <AppLayout>
      ...
      <div className="min-h-[80vh] flex items-center justify-center p-4 md:p-6">
        ...
        >
          {/* ── Top hero card ─────────────────────────────────── */}
          <div
            className="bg-white border border-gray-100 rounded-3xl shadow-lg overflow-hidden mb-4"
            ...
            <div className="px-6 md:px-8 py-6">
              ...
              <div className="flex items-start justify-between gap-4 mb-5">
                ...
                <div
                  ...
                  style={{
                    animation:
                      "popIn 0.5s cubic-bezier(0.16,1,0.3,1) 0.2s both",
                  }}
                >
                  <p
              ...
              <div className="flex items-center gap-2.5 mb-5 flex-wrap">
                {[
                  ...
                  <div
                    key={s.label}
                    className={`flex items-center gap-2.5 ${s.bg} border ${s.border} rounded-xl px-4 py-2.5`}
                  >
                    <div
                    ...
                    <div>
                      <p
                        className={`text-base font-extrabold leading-none ${s.color}`}
                      >
                        {s.value}
                      </p>
          ...
          {score < total && (
            <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-4">
              ...
              <p className="text-xs text-red-600 mb-3">
                You got these wrong — Atlas detects a pattern, not just a
                knowledge gap:
              </p>
              <div className="space-y-2.5">
                {QUESTIONS.filter((_, i) => answers[i] !== QUESTIONS[i].correct)
                  .map((q, idx) => (
                    <div
                      key={q.id}
                      className="bg-white border border-red-100 rounded-xl px-3.5 py-3"
                    >
                      <p className="text-xs font-semibold text-gray-800 mb-1">
                        "{q.question}"
                      </p>
                      <div className="flex items-start gap-2">
                        <span className="text-[10px] font-bold text-red-600 flex-shrink-0 mt-0.5">
                          ✗ You likely think:
                        </span>
                        <p className="text-[11px] text-red-700">
                          The answer is during Prophase — but it's actually{" "}
                          <strong>Prometaphase</strong>. This is a common
                          misconception: the nuclear envelope starts fragmenting
                          in Prophase but fully breaks down in Prometaphase.
                        </p>
                      </div>
                      <a
                        href="/study-guide"
            ...
            <div className="divide-y divide-gray-50">
              {QUESTIONS.map((q, i) => {
                ...
                return (
                  <div
                    key={q.id}
                    className={`px-6 md:px-8 py-4 flex items-start gap-4 ${!isRight ? "bg-red-50/30" : ""}`}
                  >
                    {/* Status circle */}
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-extrabold flex-shrink-0 mt-0.5 ${
                        isRight
                    ...
                    <span className="text-[10px] text-gray-400 flex-shrink-0 hidden sm:inline mt-1">
                      Q{i + 1}
                    </span>
                  </div>
                );
...
export default function QuizPage() {
  ...
  useEffect(() => {
    if (
      ...
      localStorage.getItem("atlas_has_quiz") === "true"
    ) {
      setHasQuiz(true);
    }
  }, []);
      ...
      <AppLayout>
        <div className="min-h-screen bg-[#F5F5FB] p-4 md:p-8">
          <div className="max-w-[960px] mx-auto">
           ...
           <div className="relative overflow-hidden bg-[#F4F2FF] border border-[#E8E5FD] rounded-2xl shadow-sm mb-3">
  ...
  <div className="relative z-10 p-4 lg:px-3">
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
      
      {/* Left Content */}
      <div className="flex flex-row sm:flex-row items-start gap-4 lg:max-w-[55%]">
        
        {/* Icon */}
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#534AB7] to-[#7B6FE8] flex items-center justify-center shadow-lg shadow-[#534AB7]/30 shrink-0">
          <HelpCircle className="w-7 h-7 text-white" />
        </div>

        {/* Text */}
        <div>
          <span className="inline-flex items-center px-3 py-1 rounded-full bg-violet-100 text-violet-700 text-xs font-semibold uppercase tracking-wider border border-violet-200 mb-2">
            Quiz
          </span>

          <h1 className="text-[19px] sm:text-2xl font-extrabold text-[#14142B] leading-tight">
            No questions ready yet
          </h1>

          <p className="text-sm sm:text-base text-[#6B6A8A] mt-2 leading-relaxed max-w-xl">
            Upload course materials and Atlas writes a quiz tailored to what
            your professor covers.
          </p>
        </div>
      </div>
      ...
      <Link
        ...
        className="
          ...
          bg-[#534AB7] hover:bg-[#3F3795]
          text-white px-2 py-3 lg:mb-16
          rounded-xl font-bold text-sm
          shadow-md shadow-[#534AB7]/25
      ...
      >
        ...
        Upload materials
            ...
            <div className="bg-white border border-[#ECE9FF] rounded-xl shadow-sm mb-6">
              <div className="grid grid-cols-3 divide-x divide-[#ECE9FF]">
                {[
                  ...
                  >
                    <div
                      className={` w-8 h-8 md:w-12 md:h-12 rounded-xl ${s.iconBg} flex items-center justify-center flex-shrink-0`}
                    >
                      <s.icon
                        className={`w-4 h-4 md:w-6 md:h-6 ${s.iconColor}`}
                      />
                    </div>
                    <div>
                      <p className="text-base md:text-xl font-extrabold text-[#14142B] leading-none">
                        {s.value}
                      </p>
                      <p className="text-[10px] lg:text-[13px] font-bold text-[#9B9AB5] uppercase tracking-wider mt-1">
                        {s.label}
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative bg-white border-2 border-dashed border-[#D8D3FF] rounded-3xl shadow-sm overflow-hidden mb-6">
              {/* Header */}
              <div className="flex flex-col md:flex-row items-center justify-between px-5 py-3 border-b border-[#ECE9FF] bg-[#F4F2FF]">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-[#534AB7]" />
                  <h3 className="text-sm font-extrabold text-[#14142B]">
                    A glimpse of what Atlas writes
                  </h3>
                </div>
                <span className="inline-flex items-center mt-1 gap-1.5 text-[10px] font-extrabold uppercase tracking-wider bg-white text-[#534AB7] px-2 py-1 rounded-full border border-[#D8D3FF]">
              ...
              <div className="relative p-6 opacity-[0.6] pointer-events-none select-none">
                <p className="text-[11px] font-bold text-[#534AB7] uppercase tracking-widest mb-2">
                  Question 1 of 10
                </p>
                <h4 className="text-base md:text-lg font-extrabold text-[#1A1A2E] leading-snug mb-5">
                  During which phase of mitosis does the nuclear envelope fully
                  break down?
                </h4>
                <div className="space-y-2">
                  {[
                    ...
                    >
                      <span
                        className={`w-7 h-7 rounded-lg flex items-center justify-center text-[12px] font-extrabold flex-shrink-0 ${
                          opt.highlight
                            ? "bg-emerald-500 text-white"
                            : "bg-[#F4F2FF] text-[#534AB7]"
                        }`}
                      >
                        {opt.letter}
                      </span>
                      <span
                        className={`text-[13.5px] font-semibold ${opt.highlight ? "text-emerald-900" : "text-[#3A3A52]"}`}
                      >
                        {opt.text}
                      </span>
                      {opt.highlight && (
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[13px] text-[#6B6A8A]">
                      Upload materials to get your real quiz.
                    </p>
                  </div>
                </div>
                <Link
            ...
            <div className="space-y-2.5 mb-6">
              {[
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[14px] font-extrabold text-[#1A1A2E] mb-0.5">
                      {s.title}
                    </p>
            ...
            <div className="flex  flex-col lg:flex-row items-end lg:items-center justify-between gap-3 text-[14px] text-[#9B9AB5] px-2">
  ...
  const goNext = () => {
    ...
    setAnswered(
      nextAns === null
        ? "unanswered"
        : nextAns === QUESTIONS[index + 1].correct
          ? "correct"
          : "wrong",
    );
  };
  ...
  const goPrev = () => {
    ...
    setAnswered(
      prevAns === null
        ? "unanswered"
        : prevAns === QUESTIONS[index - 1].correct
          ? "correct"
          : "wrong",
    );
  };
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-2.5 mb-4">
              {q.options.map((opt, i) => {
                ...
                const isWrong =
                  isSelected && !isCorrect && answered !== "unanswered";
                const isRevealed = answered !== "unanswered";

                let cls =
                  "bg-white border-2 border-gray-200 text-gray-700 hover:border-indigo-300 hover:bg-indigo-50/50 cursor-pointer";
                if (isRevealed && isCorrect)
                  cls =
                    "bg-emerald-50 border-2 border-emerald-400 text-emerald-900 cursor-default";
                else if (isWrong)
                  cls =
                    "bg-red-50 border-2 border-red-400 text-red-900 cursor-default";
                else if (isRevealed)
                  cls =
                    "bg-gray-50 border-2 border-gray-100 text-gray-400 cursor-default";
                ...
                return (
                  ...
                  >
                    <span
                      className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-extrabold flex-shrink-0 ${badge}`}
                    >
            ...
            {answered !== "unanswered" && (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p
                    className={`text-xs font-extrabold ${answered === "correct" ? "text-emerald-800" : "text-red-800"}`}
                  >
          ...
          <div className="lg:w-[190px] lg:flex-shrink-0 space-y-3">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4">
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <p className="text-[10px] font-extrabold text-indigo-800 uppercase tracking-widest">
                  Tip
                </p>
              </div>
              <p className="text-[11px] text-indigo-600 leading-relaxed">
                Read each option carefully before selecting — common traps are
                subtle word changes.
              </p>
            </div>
          </div>
