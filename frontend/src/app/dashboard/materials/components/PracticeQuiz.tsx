      ...
      <div className="px-4 py-4 pb-24">
        ...
        <div className="flex flex-col items-center py-8 gap-4">
          ...
          <div className="grid grid-cols-3 gap-3 w-full">
            <div className="bg-green-50 rounded-xl p-3 text-center">
              ...
              <p className="text-[9px] text-green-500 font-medium">Correct</p>
            </div>
            <div className="bg-red-50 rounded-xl p-3 text-center">
              <p className="text-lg font-extrabold text-red-500">{total - score}</p>
              <p className="text-[9px] text-red-400 font-medium">Incorrect</p>
            </div>
            <div className="bg-indigo-50 rounded-xl p-3 text-center">
              <p className="text-lg font-extrabold text-indigo-600">{total}</p>
              <p className="text-[9px] text-indigo-400 font-medium">Total</p>
            </div>
          </div>
        </div>
        <div className="space-y-3 mt-4">
          ...
          <button onClick={onDone}
            className="w-full text-gray-500 font-semibold py-2 text-sm hover:text-gray-700">
            Done
          </button>
        </div>
      </div>
