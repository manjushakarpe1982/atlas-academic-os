      ...
      {open && (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-72 bg-white h-full flex flex-col shadow-2xl">
            {/* Drawer header */}
            <div className="bg-indigo-600 px-5 pt-10 pb-6">
              ...
              <div className="flex items-center gap-3 bg-white/10 rounded-2xl px-3 py-2.5">
                <div className="w-9 h-9 bg-white rounded-full flex items-center justify-center text-indigo-600 font-extrabold text-sm">P</div>
                <div>
                  <p className="text-white font-bold text-sm">Pooja Sharma</p>
                  <p className="text-indigo-200 text-xs">pooja@student.edu</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto py-2">
              <p className="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest px-5 py-2">ALL SCREENS</p>
              {MENU_ITEMS.map(item => {
            ...
            <div className="border-t border-gray-100 p-4 space-y-1">
              <Link href="/help" onClick={() => setOpen(false)}
                className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600 hover:bg-gray-50 rounded-xl font-semibold">
              ...
              <button className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-red-500 hover:bg-red-50 rounded-xl font-semibold">
