                    ...
                    <div className="fixed left-4 right-4 top-12 bg-white rounded-lg shadow-2xl border border-gray-300 overflow-hidden z-50">
                      ...
                      <div className="max-h-80 overflow-y-auto divide-y divide-gray-50">
                        {NOTIFICATIONS.map((n) => (
                          ...
                          >
                            <div
                              className={`w-9 h-9 ${n.iconBg} rounded-xl flex items-center justify-center flex-shrink-0`}
                            >
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-white pb-14 h-full flex flex-col shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto py-2">
              <p className="text-[14px] font-extrabold text-gray-400 uppercase tracking-widest px-5 py-2">
                ALL SCREENS
              </p>
              {MENU_ITEMS.map((item) => {
