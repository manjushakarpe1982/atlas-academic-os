            ...
            {step < 5 && (
              <div className="flex-shrink-0 bg-white border-t border-[#EEEDFE] px-3 md:px-6 py-3 md:py-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-sm md:text-base font-medium text-indigo-600 hover:text-[#534AB7] "
                >
                  Skip for now
                </button>
                ...
                <div className="flex items-center gap-3">
                  {prevHref ? (
                    <Link
                      href={prevHref}
                      className="flex items-center gap-1.5 text-sm font-semibold text-[#6B6A8A] hover:text-[#534AB7] border border-[#E8E5FD] hover:border-[#534AB7]/40 px-3 md:px-5 py-2.5 rounded-xl hover:bg-[#F8F7FF] transition-all"
                    >
                      <ArrowLeft className="w-4 h-4" /> Back
                    </Link>
                  ) : (
                    <span className="flex items-center gap-1.5 text-sm font-semibold text-[#D5D3F0] px-3 md:px-5 py-2.5 rounded-xl border border-[#F0EFF8] cursor-not-allowed select-none">
                      <ArrowLeft className="w-4 h-4" /> Back
                    </span>
                  )}
                  {nextHref && (
