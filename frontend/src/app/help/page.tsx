...
const STEPS = [
  {
    ...
    listLabel: "",
    items: ["Search for your school",  "Tap Continue"],
  ...
  },
  {
    ...
    listLabel: "You can",
    items: [
      "Review all assignments, exams & dates",
      "Edit or delete incorrect items",
  ...
  },
  {
    ...
    items: [
      ...
      "Scan graded paper",
      "Upload LMS screenshot / PDF",
      "Atlas calculates your current grade in each class",
    ],
    ...
    <div className="min-h-screen bg-white max-w-md mx-auto flex flex-col">
      ...
      <div className="w-full">
        ...
        <div className="bg-white rounded-b-3xl px-4 pb-3 ">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
            Atlas uses AI to turn your syllabus, grades, and calendar into a
            personalized plan that helps you improve your grades.
          </p>
            ...
            {STEPS.map((s) => {
              ...
              return (
                <div key={s.num} className="flex items-start gap-2">
                  ...
                  {/* Card — expandable */}
                  <div
                    className={`flex-1 border rounded-xl shadow-sm transition-all overflow-hidden ${isOpen ? "bg-white border-indigo-200 shadow-md" : "bg-white border-gray-100 hover:shadow-md"}`}
                  >
                    <div
      ...
      <div className="relative w-full rounded-xl overflow-hidden h-[360px] md:h-[340px]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end p-2  text-center">
          ...
          <button className="flex items-center justify-center gap-2 w-full max-w-[280px] mx-auto border-2 bg-white border-white/40 hover:border-white text-indigo-600 font-bold py-3 rounded-xl text-sm transition-all">
