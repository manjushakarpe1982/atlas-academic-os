...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Supabase sends the reset email automatically — no backend needed
        ...
        <div className="bg-white rounded-3xl border border-[#ECE9FF] shadow-xl p-7 md:p-9">
          ...
          {success ? (
            <div className="text-center py-2">
              ...
              <p className="text-base font-extrabold text-[#14142B] mb-2">Check your inbox</p>
              ...
              <div className="text-left bg-[#F4F2FF] border border-[#E8E5FD] rounded-2xl p-4 mb-5">
                ...
                <ol className="space-y-2 text-[13px] text-[#3A3A52]">
                  {[
                    ...
                    "Set a new password on the page that opens",
                  ].map((step, i) => (
                    <li key={i} className="flex gap-2.5">
                      <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[#534AB7] text-white text-[10px] font-extrabold flex items-center justify-center">
                        {i + 1}
                      </span>
                      <span>{step}</span>
                    </li>
              ...
              <p className="text-[12px] text-[#85859b] mb-1.5">Didn&apos;t get it? Check your spam folder or</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-[13px] font-bold text-[#3A3A52] mb-1.5">Email address</label>
                <input
                  type="email"
                  value={email}
              ...
              <p className="text-center text-[12px] text-[#85859b]">
                Remembered it?{" "}
                <Link href="/auth/login" className="font-semibold text-[#534AB7] hover:underline">
                  Log in
                </Link>
              </p>
            </form>
